...
public class Cricket extends AppCompatActivity {
    ...
    {
        ProgressDialog progressDialog = new ProgressDialog(Cricket.this);
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(Cricket.this, android.R.layout.simple_list_item_1, titles);
